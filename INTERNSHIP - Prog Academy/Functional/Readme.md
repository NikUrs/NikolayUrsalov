...
- <a href="The error message isn’t shown with an example of the valid format of data after sending letters for a phone number.">The error message isn’t shown with an example of the valid format of data after sending letters for a phone number.</a>
